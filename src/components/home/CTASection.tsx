...
export function CTASection() {
  ...
  const benefits = [
    { icon: Users, text: "Priority access to new features" },
    { icon: Clock, text: "Free implementation support" },
    { icon: Shield, text: "Exclusive pricing for early adopters" }
  ];
      ...
      <div className="relative max-w-4xl mx-auto text-center px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {benefits.map((benefit, index) => (
            <div key={index} className="flex items-center gap-3 text-blue-100 text-sm">
